...
namespace FastColoredTextBoxNS
{
    public partial class Ruler : UserControl
    {
        ...
        void Target_VisibleRangeChanged(object sender, EventArgs e) => Invalidate();
        void Target_SelectionChanged(object sender, EventArgs e) => Invalidate();
        protected virtual void Target_Scroll(object sender, ScrollEventArgs e) => Invalidate();
